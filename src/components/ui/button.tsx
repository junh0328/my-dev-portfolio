  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        outline:
          'liquid-glass-subtle hover:liquid-glass border-border rounded-xl',
        secondary:
          'liquid-glass-subtle text-secondary-foreground hover:liquid-glass rounded-xl',
        ghost:
          'hover:liquid-glass-subtle hover:text-accent-foreground rounded-xl',
        link: 'text-primary underline-offset-4 hover:underline',
        glass:
          'liquid-glass text-foreground hover:scale-[1.02] active:scale-[0.98] rounded-xl',
      },
      size: {
